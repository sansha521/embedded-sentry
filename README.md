...
Short press (< 2 seconds) the button to try a new movement. When the same movement is created, the board should unlock. When a different movement is created, the board should remain locked. 
